...
<span>
    ...
    A exceção são os itens de moda como bolsas, sapatos e roupas, vendidos e entregues pela Americanas, que podem ser devolvidos em até 30 dias corridos. Ah, como nessa categoria a gente não tem reposição de estoque, preferimos devolver o valor na mesma forma de pagamento da compra. Também podemos enviar um Vale-Compras pra você usar como preferir em nosso site.
    
    Para solicitar a troca ou devolução é só entrar em “Minha Conta” e clicar em “Trocar ou Devolver” ou acessar o aplicativo da Americanas. Se preferir, clique aqui e veja os contatos da nossa Central de Atendimento.
    ...
    Produtos com defeito podem ser trocados ou devolvidos em até 90 dias corridos, se forem bens duráveis (por exemplo, geladeira e ar-condicionado), e 30 dias corridos, se forem bens não duráveis (por exemplo, alimentos e bebidas).
    ...
    Se você comprou um produto vendido e entregue pela americanas, a devolução pode ser feita por postagem nos Correios, exatamente do jeito que a gente explicou no item 3.1, e por coleta, por causa do tamanho (produtos grandes como geladeiras) e da complexidade.
    ...
    a gente receber o que você devolveu no Centro de Distribuição da americanas, analisar e não estiver tudo de acordo com o que você relatou;
